        ...
        getDdps.setCallback(this, function(response) {
            if (response.getState() === 'SUCCESS') {
                ...
                if (parsedResponse.isSuccess) {
                    ...
                    helper.fireErrorEvent(component, 'There was a problem retrieving Document Packages.');
                }
            }
            else {
                helper.fireErrorEvent(component, 'There was a problem retrieving Document Packages.');
        ...
        migrateDdps.setCallback(this, function(response) {
            ...
            if (response.getState() == 'SUCCESS') {
                ...
                if (parsedResponse.isSuccess) {
                    ...
                    helper.fireErrorEvent(component, 'There was a problem migrating Document Packages.');
                    moveToNextStep.setParams({
                        success: false
                    });
                }
