                ...
                if (parsedResponse.isSuccess) {
                    ...
                    if (parsedResponse.isSalesforce1) {
                        ...
                        if (parsedResponse.needsAuthentication) {
                            ...
                            component.set('v.errorMessage', 'To generate documents in Salesforce1, you must first generate a document from a desktop where authorization is required. This authorizes your account for Nintex Drawloop.');
