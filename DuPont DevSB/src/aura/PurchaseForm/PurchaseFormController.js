({
    ...
    submit : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            var errorMessage = "An unexpected error has occurred. Please contact Nintex Drawloop Support if this error persists.";
            ...
            if (response.getState() === 'SUCCESS') {
                ...
                if (parsedResponse.status === 'success') {
                    ...
                    if (parsedResponse.ErrorId) {
                        ...
                        errorMessage = responseMessage + ' Include this Error Id if you contact Nintex Drawloop Support: ' + parsedResponse.ErrorId;
                    }
