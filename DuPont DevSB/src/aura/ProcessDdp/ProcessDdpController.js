    ...
    onInit : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            if (response.getState() === "SUCCESS") {
                ...
                $A.util.addClass(component.find("panel-preview"), "hidden");
                component.set("v.hasErrored", true);
                component.find("panel-error").getElement().innerHTML = 'An unexpected error has occurred. Please contact Nintex Drawloop Support if this error persists.';
            }
        });
            ...
            action.setCallback(this, function(response) {
                if (response.getState() === "SUCCESS") {
                    ...
                    if (parsedResponse.isSuccess) {
                        ...
                        var styleUrl = "/resource/Loop__Styles/css/process-ddp.css";
